...
describe('Sprint 7 Challenge Learner Tests', () => {
  ...
  */
    it(`sum() // throws an error 'pass valid numbers'`, () => {
      expect(() => sum()).toThrowError('pass valid numbers')
    })
    it(`sum(2, 'seven') // throws an error 'pass valid numbers'`, () => {
      expect(() => sum(2, 'seven')).toThrowError('pass valid numbers')
    })
    it(`sum(1, 3) // returns 4'`, () => {
      expect(sum(1, 3)).toBe(4)
    })
    it(`sum('1', 2) // returns 3`, () => {
      expect(sum('1', 2)).toBe(3)
    })
    it(`sum('10', '3') // returns 13`, () => {
